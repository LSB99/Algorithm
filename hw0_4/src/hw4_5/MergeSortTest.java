...
//작성자: 임수빈
//작성일: 2020년 4월 10일
//내용: [hw4_5] 병합 정렬(merge sort) 알고리즘을 이용하여 도형을 면적 오름차순으로 정렬하는 자바 프로그램을 작성한다.
//***************************

public class MergeSortTest { // 메인 클래스
	
	public static void main(String[] args) {
		
		Scanner scanner = new Scanner(System.in);  // scanner 객체 생성
		System.out.println("hw4_5 : 임수빈 \n");  // 과제코드 이름 출력
		...
		FigureSortService.mergeSort(figureArray); //도형 배열을 병합 정렬
