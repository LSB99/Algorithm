package hw0_8;
//***************************
//파일명: Stonedynamic.java
//작성자: 임수빈
//작성일: 2020년 5월 20일
//내용:  돌 놓기 문제  동적프로그래밍 알고리즘
//***************************

public class Stonedynamic {
	
	private int[][] w;  
	private int[][] peb; 
	
	public Stonedynamic(int row, int col) {  // 생성자
		w = new int[row][col];   // 3 x col  테이블
		peb = new int[row+1][col]; // 4 x col 배열
	}
